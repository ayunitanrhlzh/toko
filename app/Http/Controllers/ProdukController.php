...
class ProdukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['slug_produk'] = Str::slug($request->slug_produk);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData = Produk::findOrFail($id);//cari berdasarkan id = $id, 
        // kalo ga ada error page not found 404
        $slug = Str::slug($request->slug_produk);//slug kita gunakan nanti pas buka produk per produk
